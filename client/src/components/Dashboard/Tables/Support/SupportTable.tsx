...
const columns: Column<Row>[] = useMemo(
  ...
  return (
    <div className="w-tableWidth mx-auto pr-32">
      ...
      <div className="datepickers mr-1 flex text-xs space-x-3">
        ...
        <div className="search-container w-[20%] flex items-center mt-4">
          ...
          <FaSearch
            ...
            className = "absolute right-[15rem] md:right-[15.5rem] lg:right-[16rem] 2xl:right-[18.2rem]"
           size = {17} 
           color = "#00548C"/>
        </div>
  ...
  <div className="flex pl-10 flex-row mt-2">
