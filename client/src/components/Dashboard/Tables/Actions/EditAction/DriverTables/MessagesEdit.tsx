          ...
          <div>
            <label className="ml-[2.70rem] inline-flex items-center text-[0.68rem] space-x-3">
              <input
                type="radio"
                value="Completed"
                checked={editedData.Remarks === "Completed"}
                onChange={() =>
                  setEditedData({ ...editedData, Remarks: "Completed" })
                }
            ...
            <label className="inline-flex items-center ml-2 text-[0.68rem] space-x-3">
              <input
                type="radio"
                value="In Progress"
                checked={editedData.Remarks === "In Progress"}
                onChange={() =>
                  setEditedData({ ...editedData, Remarks: "In Progress" })
                }
