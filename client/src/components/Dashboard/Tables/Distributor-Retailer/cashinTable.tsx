...
import EditDetailsAction from "../Actions/EditAction/DistributorRetailerTables/CashInEdit";
import AddDetailsAction from '../Actions/AddAction/DistributorRetailerTables/CashInAdd';
  ...
  useEffect(() => {
    const filtered = data.filter((item) => {
      return (
        ...
        item.bankPartner.toLowerCase().includes(searchTerm.toLowerCase()) ||
  ...
  return (
    <div className="w-tableWidth mx-auto">
      ...
      <div className="datepickers mr-10 flex text-xs space-x-3">
        ...
        />
        <FaSearch
          className="absolute right-[7.2rem] lg:right-[8.50rem] 2xl:right-[10.4rem] top-[9.1rem] transform -translate-y-1/2"
          size={17}
          color="#00558d"
        />
        </div>
